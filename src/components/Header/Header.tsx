...
export const Header = ({ logoSmall, setIsSidebarVisible }: any) => {
  return (
    <header className={styles.header}>
      ...
      <div className={cn(styles.header_side, styles.header_side_right)}>
        ...
        <Button rounded transparent className={cn(styles.header_mobile_book_phone_call, styles.header_rounded)}>
        ...
        <Button gold_100 className={cn(styles.header_desktop_book_phone_call)}>
          Заказать звонок
        </Button>
      </div>
    </header>
